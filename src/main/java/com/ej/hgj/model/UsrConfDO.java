...
public class UsrConfDO {
    ...
    public String getPfeeEndMon() {
        return pfeeEndMon;
    }

    public void setPfeeEndMon(String pfeeEndMon) {
        this.pfeeEndMon = pfeeEndMon;
    }

    public String getHeoMsgOpen() {
        return heoMsgOpen;
    }

    public void setHeoMsgOpen(String heoMsgOpen) {
        this.heoMsgOpen = heoMsgOpen;
    }
    ...
    public Short getMaxPoCnt() {
        return maxPoCnt;
    }

    public void setMaxPoCnt(Short maxPoCnt) {
        this.maxPoCnt = maxPoCnt;
    }

    public Short getMaxHuCnt() {
        return maxHuCnt;
    }

    public void setMaxHuCnt(Short maxHuCnt) {
        this.maxHuCnt = maxHuCnt;
    }
    ...
    public String getHuOpenMode() {
        return huOpenMode;
    }

    public void setHuOpenMode(String huOpenMode) {
        this.huOpenMode = huOpenMode;
    }

    public String getIsPackCode() {
        return isPackCode;
    }

    public void setIsPackCode(String isPackCode) {
    ...
    public String getRepairAssign() {
        return repairAssign;
    }

    public void setRepairAssign(String repairAssign) {
        this.repairAssign = repairAssign;
    }

    public Integer getRepairTimeCnt() {
        return repairTimeCnt;
    }

    public void setRepairTimeCnt(Integer repairTimeCnt) {
        this.repairTimeCnt = repairTimeCnt;
    }

    public String getAuditBitmap() {
        return auditBitmap;
    }

    public void setAuditBitmap(String auditBitmap) {
        this.auditBitmap = auditBitmap;
    }

    public Integer getHomeImgCnt() {
        return homeImgCnt;
    }

    public void setHomeImgCnt(Integer homeImgCnt) {
        this.homeImgCnt = homeImgCnt;
    }

    public String getWxPubGreet() {
        return wxPubGreet;
    }

    public void setWxPubGreet(String wxPubGreet) {
        this.wxPubGreet = wxPubGreet;
    }
    ...
    public String getPackPageTip() {
        return packPageTip;
    }

    public void setPackPageTip(String packPageTip) {
        this.packPageTip = packPageTip;
    }
    ...
    public Integer getAdvPfeeMon() {
        return advPfeeMon;
    }

    public void setAdvPfeeMon(Integer advPfeeMon) {
        this.advPfeeMon = advPfeeMon;
    }

    public String getPfeeStartMon() {
        return pfeeStartMon;
    }

    public void setPfeeStartMon(String pfeeStartMon) {
        this.pfeeStartMon = pfeeStartMon;
    }
    ...
    public String getRepairBtypeId() {
        return repairBtypeId;
    }

    public void setRepairBtypeId(String repairBtypeId) {
        this.repairBtypeId = repairBtypeId;
    }
    ...
    public String getPfeePayCyc() {
        return pfeePayCyc;
    }

    public void setPfeePayCyc(String pfeePayCyc) {
        this.pfeePayCyc = pfeePayCyc;
    }

    public String getIsPfeeSpan() {
        return isPfeeSpan;
    }

    public void setIsPfeeSpan(String isPfeeSpan) {
        this.isPfeeSpan = isPfeeSpan;
    }

    public String getPfeeRemark() {
        return pfeeRemark;
    }

    public void setPfeeRemark(String pfeeRemark) {
        this.pfeeRemark = pfeeRemark;
    }
