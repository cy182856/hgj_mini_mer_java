...
//        String infoStr = JSONObject.toJSONString(jsonArraySysWin.get(0));
    ...
    public static JSONObject callSy(String p0, String p7, String token, String url){
        StringBuffer params = new StringBuffer();
        params.append("p0=" + p0);
    ...
    public static JSONObject returnVisitCallSy(String p0, String p7, String token ,String url){
        StringBuffer params = new StringBuffer();
        params.append("p0=" + p0);
        params.append("&p1=" + "");
        params.append("&p2=" + "");
