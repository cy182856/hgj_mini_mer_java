...
public class QyApiUtils {
     ...
     * @return
     */
    public static JSONObject getUserInfo3rd(String suiteAccessToken, String code) {
        JSONObject jsonObject = httpRequest(JS_CODE2_SESSION_SERVICE.replace("SUITE_ACCESS_TOKEN", suiteAccessToken).replace("CODE",code), GET, null);
        return jsonObject;
    }
    ...
    public static JSONObject getSuiteAccessToken(String suiteId, String suiteSecret, String suiteTicket) {
        ...
        String jsonStr = com.alibaba.fastjson.JSONObject.toJSONString(params);
        JSONObject jsonObject = httpRequest(GET_SUITE_TOKEN, POST, jsonStr);
